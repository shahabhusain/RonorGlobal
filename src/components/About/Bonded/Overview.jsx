...
const Overview = () => {
  return (
        <div className='w-[95%] mx-auto'>
              <div className=' bg-[#0C1644] p-20 rounded-2xl mt-20 gap-12 flex items-center justify-between '>
             <div className=' flex flex-col gap-5 w-[60%]'>
             <h1 className=' text-white text-[40px] font-[800]'>Overview</h1>
        <p className=' text-[20px] font-[500] text-white'>For any queries, concerns or the nedd for further clarification this scheme,
        ...
        <p className=' text-[20px] font-[800] text-white'>India allows manufacturing and other operations in a bonded 
        manufacturing facility.</p>
        <p className=' text-[20px] font-[500] text-white'>With the Government's continuous efforts to promote India as the manufacturing
...
<p className=' text-[20px] font-[500] text-white'>When the raw material or capital goods are imported, the import duty in them id deferred. 
...
and when the capital goods are cleared to the domestic market.</p>
             ...
             <img className=' w-[40%]' src={main} alt="" />
    </div>
