  ...
  return (
    <div>
        ...
        <div className=' flex flex-col md:flex-row items-center gap-5 mt-12'>
            ...
            <button className=' text-white bg-[#00105C] p-4 rounded-md xl:text-[24px] lg:text-[22px] md:text-[20px] text-[18px] font-[600]'>Email: indiaatdavos@investindia.org.in</button>
        </div>
          </div>
    </div>
  )
