  ...
  return (
    <div className=' flex items-center gap-12 bg-[#00105C] py-12 md:px-0 px-4 w-[95%] mx-auto md:my-20 my-5 rounded-3xl'>
        ...
        <div>
          ...
          <button className='xl:text-[20px] lg:text-[17px] md:text-[15px] text-[10px] font-[700] rounded-full text-[#00105C] bg-white py-2 px-5 flex items-center gap-4'>VIEW INDIA OPPORTUNITY <FaArrowRight /></button>
