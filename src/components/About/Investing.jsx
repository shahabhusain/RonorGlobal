...
const Investing = () => {
  return (
    <div className=' flex items-center gap-12 bg-[#00105C] py-12 md:px-0 px-4 w-[95%] mx-auto my-20 rounded-3xl'>
        ...
        <p className=' xl:text-[16px] lg:text-[14px] md:text-[12px] text-[10px] font-[400] text-white'>As ghana’s national investment promotion agency, Invest ghana acts as a concierge, gateway, and facilitator for every investor, trader, and R&D partner looking to engage with India.</p>
        ...
        <div>
          ...
          <button className='xl:text-[20px] lg:text-[17px] md:text-[15px] text-[14px] font-[700] rounded-full text-[#00105C] bg-white py-2 px-5 flex items-center gap-4'>VIEW INDIA OPPORTUNITY <FaArrowRight /></button>

<button className='xl:text-[20px] lg:text-[17px] md:text-[15px] text-[14px] font-[700] rounded-full text-[#00105C] bg-white py-2 px-5 flex items-center gap-4'>CONTACT US NOW<FaArrowRight /></button>
          </div>
        </div>
          </div>
             </div>
