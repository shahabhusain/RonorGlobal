          ...
          <div className=" flex flex-col items-center justify-center gap-y-4">
             <img src={icon1} alt="" />
               <div className='bg-red-800 p-4 min-h-[120px] rounded-lg flex-1 text-white text-center'>
                <div className="text-[24px] font-bold mb-2">650-700%</div>
...
in Ghana
          ...
          {/* Stat 2 */}
           <div className=" flex flex-col items-center justify-center gap-y-4">
             <img src={icon2} alt="" />
               <div className='bg-red-800 p-4 min-h-[120px]  rounded-lg flex-1 text-white text-center'>
                <div className="text-[24px] font-bold mb-2">33%</div>
            <div className="text-[20px] font-[600] max-w-[344px]">
...
Ghana
          ...
          <div className=" flex flex-col items-center justify-center gap-y-4">
             <img src={icon3} alt="" />
               <div className='bg-red-800 p-4 min-h-[120px]  rounded-lg flex-1 text-white text-center'>
                <div className="text-[24px] font-bold mb-2">10-11%</div>
            <div className="text-[20px] font-[600] max-w-[344px]">
      ...
      <div className="p-6 mt-12 w-[95%] mx-auto ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="civil3 p-5">
            <h3 className="font-bold text-[24px] mb-2 text-gray-800">Increasing Demand for 
Premium Products</h3>
            <p className="text-[20px] font-[500] text-gray-700">
Ghana’s consumers' growing desire for premium beauty products, fueled by higher incomes and changing lifestyles, is driving the premium segment, which is expected to reach $3-3.2 Bn by 2028.
          ...
          <div className="civil4 p-5">
            <h3 className="font-bold mb-2 text-[24px] text-gray-800">Diverse Consumer Base 
and Market Segmentation</h3>
            <p className="text-[20px] font-[500] text-gray-700">
