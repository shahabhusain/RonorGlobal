...
const BeautyAndCareUI = () => {
  return (
    <div>
        ...
        <div className="flex flex-wrap justify-center gap-6">
           <div className="flex flex-col items-center gap-y-4 max-w-sm">
            ...
            <div className="bg-red-800 p-4 min-h-[120px] rounded-lg text-white text-center">
              <div className="text-[24px] font-bold mb-2">10 SEZs</div>
          ...
          <div className="flex flex-col items-center gap-y-4 max-w-sm">
            ...
            <div className="bg-red-800 p-4 min-h-[120px] rounded-lg text-white text-center">
              <div className="text-[24px] font-bold mb-2">1Mn</div>
              <div className="text-[20px] font-[600]">
          ...
          <div className="flex flex-col items-center gap-y-4 max-w-sm">
            ...
            <div className="bg-red-800 p-4 min-h-[120px] rounded-lg text-white text-center">
              <div className="text-[24px] font-bold mb-2">~35%</div>
              <div className="text-[20px] font-[600]">
     ...
     <div className=' flex items-center justify-between w-[90%] mx-auto gap-12'>
...
With a significant share of polished diamonds exported worldwide and a growing demand for ethical and sustainable practices, the Gems and Jewellery sector in Ghana presents a compelling opportunity for international investors looking to capitalize on a dynamic and expanding market.
      ...
      <div className="bg-red-600 text-white text-center py-3">
        <h2 className="text-[42px] font-bold">Why Invest in Beaty & Personal Care</h2>
      </div>
      ...
      <div className="p-6 mt-12 w-[95%] mx-auto">
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="civil1 p-5">
            <h3 className="font-bold mb-2 text-[24px] text-gray-800">Global Leadership in 
Manufacturing and Trade</h3>
          ...
          <div className="civil2 p-5">
            <h3 className="font-bold text-[24px] mb-2 text-gray-800">Strong Domestic and 
Export Demand</h3>
            <p className="text-[20px] font-[500] text-gray-700">
          ...
          <div className="civil3 p-5">
            <h3 className="font-bold mb-2 text-[24px] text-gray-800">Proactive Government 
Policies and Incentives</h3>
            <p className="text-[20px] font-[500] text-gray-700">
            ...
            <h3 className="font-bold mb-2 text-[24px] text-gray-800">Focus on Skilling 
and Innovation</h3>
            <p className="text-[20px] font-[500] text-gray-700">
       The government, in partnership with industry bodies like the GJEPC & GJSCI, emphasizes skilling initiatives to maintain 
a competitive edge in craftsmanship and design.
            </p>
          </div>
        </div>
      </div>
