      ...
      <div className=" mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mt-12 lg:grid-cols-3 gap-4 mb-6 w-[95%] mx-auto">
          ...
          <div className="bg-[#00105C] text-white   pt-4 rounded-lg relative">
            <div className="text-[24px]  font-medium px-4">
              Export Promotion Capital
Goods (EPCG) scheme
            </div>
            <button className=' text-[37px] font-[700] bg-red-500 text-white py-3 px-5 w-full mt-6'>Download</button>
          </div>
...
Certification Scheme
          ...
          <div className="bg-[#00105C]  text-white pt-4 rounded-lg relative">
            ...
            <button className=' text-[37px] font-[700] bg-red-500 text-white py-3 px-5 w-full mt-[3.8rem]'>Download</button>
          </div>
        </div>
