...
const PolicyArchiveAndSuccessStories = () => {
  ...
  return (
    <div className="">
      ...
      <div className=' mt-20'>
          ...
          <h2 className="xl:text-[42px] lg:text-[35px] md:text-[30px] text-[25px]  font-bold">Major Investors</h2>
        </div>
        <div className=' flex flex-col md:flex-row items-center gap-12 mt-12 justify-between bg-[#002be855] md:p-12 p-4 w-[95%] mx-auto '>
      ...
      <div className=" mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mt-12 lg:grid-cols-5 gap-4 mb-6 w-[95%] mx-auto">
          ...
          <div className="bg-[#00105C] text-white border-b-red-600 border-b-[6px] p-4 rounded-lg relative">
            ...
            <div className="md:text-[20px] text-[12px] max-w-[200px]  font-medium">
        ...
        <div className="bg-red-600 text-white mt-20 text-center py-3 mb-6">
          <h2 className="xl:text-[42px] lg:text-[35px] md:text-[30px] text-[25px]  font-bold">Policy Archive</h2>
        </div>
        ...
        <div className="grid grid-cols-1 mt-12 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8 w-[95%] mx-auto">
          ...
          <div className="bg-[#00105C] text-white p-4 rounded-lg border-l-8 border-red-500">
            <div className="md:text-[20px] text-[12px] font-[600]  text-white mb-1">RCS - UDAN Scheme 2022</div>
            <div className="md:text-[20px] text-[12px] font-normal mb-2">RCS - UDAN Scheme 2022</div>
            <div className="flex items-center md:text-[20px] text-[12px] font-[600]">
          ...
          {/* Archive Card 2 */}
          <div className="bg-[#00105C] text-white p-4 rounded-lg border-l-8 border-red-500">
            <div className="md:text-[20px] text-[12px] font-[600]  text-white mb-1">National Logistics Policy 2022</div>
            <div className="md:text-[20px] text-[12px] font-normal mb-2">The guideline aim to enable private and public</div>
            <div className="flex items-center md:text-[20px] text-[12px] font-[600]">
              <svg className="w-6 h-6 mr-1" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
          ...
          {/* Archive Card 3 */}
          <div className="bg-[#00105C] text-white p-4 rounded-lg border-l-8 border-red-500">
            <div className="md:text-[20px] text-[12px] font-[600]  text-white mb-1">National UTM policy Framework - 2021</div>
            <div className="md:text-[20px] text-[12px] font-normal mb-2">National UTM policy Framework - 2021</div>
            <div className="flex items-center md:text-[20px] text-[12px] font-[600]">
              <svg className="w-6 h-6 mr-1" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
          ...
          {/* Archive Card 4 */}
          <div className="bg-[#00105C] text-white p-4 rounded-lg border-l-8 border-red-500">
            <div className="md:text-[20px] text-[12px] font-[600]  text-white mb-1">Drone Import policy 2022</div>
            <div className="md:text-[20px] text-[12px] font-normal mb-2">Drone Import policy 2022</div>
            <div className="flex items-center md:text-[20px] text-[12px] font-[600]">
              <svg className="w-6 h-6 mr-1" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
          ...
          {/* Archive Card 5 */}
          <div className="bg-[#00105C] text-white p-4 rounded-lg border-l-8 border-red-500">
            <div className="md:text-[20px] text-[12px] font-[600]  text-white mb-1">National Air Sports policy, 2022</div>
            <div className="md:text-[20px] text-[12px] font-normal mb-2">National Air Sports policy, 2023</div>
            <div className="flex items-center md:text-[20px] text-[12px] font-[600]">
              <svg className="w-6 h-6 mr-1" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
        ...
        <div className="bg-red-600 text-white text-center py-3 mb-6 mt-20">
          <h2 className="xl:text-[42px] lg:text-[35px] md:text-[30px] text-[25px]  font-bold">Featured Success Stories</h2>
        </div>

        {/* Success Stories Container */}
        <div className="bg-[#00105C] mt-12 text-white p-4 sm:p-6 rounded-lg relative overflow-hidden w-[95%] mx-auto">
  {/* Navigation Arrows */}
  <button 
    onClick={prevSlide}
  ...
  <div className="flex flex-col md:flex-row justify-between items-start mb-4 gap-4">
    <div>
      <h3 className="text-2xl sm:text-4xl font-bold mb-2">Featured Success Stories</h3>
      <div className="text-white text-base sm:text-lg font-medium border-b border-red-400 inline-block">
        Inspiring Tales of Achievement and Triumph
      </div>
    </div>
    <img src={slider} alt="" className="w-28 sm:w-36 object-contain self-center md:self-start" />
  </div>

  {/* Slider Container */}
  <div className="relative h-auto min-h-[250px] sm:h-64">
    <div 
    ...
    >
      {successStories.map((story, index) => (
        <div key={index} className="w-full flex-shrink-0 mt-8">
          <div className="bg-white text-blue-900 p-3 ml-3 rounded mb-4 font-medium text-sm sm:text-base">
            {story.title}
          </div>
            ...
            <div className="space-y-3">
              {story.points.slice(0, 2).map((point, pointIndex) => (
                <div key={pointIndex} className="flex items-start">
                  ...
                  <div className="bg-white text-blue-900 p-3  rounded font-medium text-sm sm:text-base">
                    {point}
                  </div>
                </div>
              ))}
