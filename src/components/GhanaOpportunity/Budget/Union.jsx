...
const Union = () => {
  return (
     <div className='mt-20 mx:px-12 px-4'>
        ...
        <p className=' md:text-[20px] text-[12px] font-[500] mt-3'>Union Budget for the financial year 2025-26 was presented in the parliament earlier today. The budget continues the government’s efforts to accelerate growth, secure inclusive development, invigorate private sector investments, uplift household sentiments, and enhance the spending power of India’s rising middle class. Below are the edited excerpts from the budget speech made by Nirmala Sitharaman, Hon’ble Finance Minister of India.</p>
     </div>
  )
}
