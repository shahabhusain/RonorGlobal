...
const Chemical = () => {
  return (
    <div>
      ...
      Ghana's chemicals sector is a vital industry that contributes significantly to the country's economy. It encompasses a wide range of products, including petrochemicals, agrochemicals, and speciality chemicals. The sector benefits from strong domestic demand, low-cost production, and a skilled workforce. Government initiatives like the "Make in Ghana" campaign are further boosting the industry's growth. The sector offers promising opportunities for investors seeking exposure to a diverse and dynamic industry.
      </p>
