  ...
  return (
    <div>
      ...
      <div className=' flex flex-col md:flex-row items-center justify-between gap-12 mt-12'>
          ...
          <button className=' flex flex-col gap-2'><h1 className=' border-b-[2px] pb-2 border-b-red-500 text-red-500 xl:text-[20px] lg:text-[16px] md:text-[14px] text-[12px] font-[700]'>43.75%</h1> <p className=' xl:text-[18px] lg:text-[16px] md:text-[14px] text-[10px]'>increase in GVA of India’s food processing sector, ~USD 16 Bn in 2014-15 to ~USD 23 Bn in 2022-23, reinforcing its role in industrial growth and job creation.</p></button>
