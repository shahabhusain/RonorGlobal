...
const GreenEnergy = () => {
  return (
    <div>
      <h1 className=' text-[40px] font-[700] text-red-500'>Green Energy</h1>
      <p className=' text-[18px] font-[400]'>India is the world's 3rd largest energy consumer. Over the past decade, India has made significant strides in diversifying its energy mix, gradually reducing its reliance on conventional fossil fuels. India’s installed non-fossil fuel capacity has significantly increased in the last decade years and stands at 214 GW non-fossil fuel installed capacity, over 40% of the country’s total capacity.</p>
