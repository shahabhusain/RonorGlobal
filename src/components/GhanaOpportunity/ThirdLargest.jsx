...
const ThirdLargest = () => {
  return (
    <div>
      ...
      <p className=' xl:text-[18px] lg:text-[16px] md:text-[14px] text-[10px] font-[400]'>Ghana is the world's 3rd largest energy consumer. Over the past decade, India has made significant strides in diversifying its energy mix, gradually reducing its reliance on conventional fossil fuels. Ghana installed non-fossil fuel capacity has significantly increased in the last decade years and stands at 186 GW non-fossil fuel installed capacity, over 40% of the country’s total capacity.</p>
