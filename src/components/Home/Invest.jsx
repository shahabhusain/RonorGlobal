       ...
       <div className=' flex gap-12'>
         ...
         <div className=' border-[#7A7A7A] border-[2px] w-[40%] p-4'>
           <h1 className=' text-[40px] font-[700] text-[#00105C]'>Latest News</h1>
            ...
            <div className=' border-b-black border-b-[2px] pb-6 mt-6'>
            <h2 className=' text-black text-[20px] font-[500]'>Swedish home furnishing retailer, IKEA, marks strategic e-commerce foray in Ghana</h2>
            <button className=' flex items-center gap-3'>28-5-2025 .<span className=' text-red-500 underline'>Know more</span></button>
           </div>
