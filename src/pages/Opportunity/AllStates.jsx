...
const AllStates = () => {
  return (
    <div className='bg-[#00105C] pt-40 pb-12 px-12'>
      <ul>
        <li className='text-[#FF0000] text-[30px] font-[700] flex items-center gap-5'>
          All States <span><FaChevronRight /></span>
        </li>
        <li className='text-[30px] font-[500] text-white mt-4'>
          <Link to="/agriculture" className="hover:underline">Agriculture & Allied Sector</Link>
        </li>
        <li className='text-[30px] font-[500] text-white'>
